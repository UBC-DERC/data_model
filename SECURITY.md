...
Please report security vulnerabilities by filling out the following template:
    ...
    PROJECT: A URL to this project's repository (https://github.com/UBC-DERC/data_model)
...
Please send the above info, along with any other information you feel is pertinent to the package maintainer: [Simon Goring](mailto:simon.goring@ubc.ca).
...
However, Simon Goring will email you at the same time the public announcement is made. We will let you know within a few weeks whether or not your report has been accepted or rejected. We ask that you please keep the report confidential until we have made a public announcement.
