...
|institution_superceeding_fk| REFERENCES|FOREIGN KEY (superceedingrecord) REFERENCES institutions(institutionid)|[institutions](institutions.md) (institutionid)|Allows for institutions to be renamed, or get switched over time.|
