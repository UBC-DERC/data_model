...
|    datasetidentifiers_dsid_fk    | REFERENCES|              FOREIGN KEY (datasetid) REFERENCES datasets(datasetid) ON UPDATE CASCADE ON DELETE CASCADE             |          [datasets](datasets.md) (datasetid)         |                                 A foreign key to point to the dataset id.                                 |
|datasetidentifiers_externaldbid_fk| REFERENCES|FOREIGN KEY (externaldatabaseid) REFERENCES externaldatabases(externaldatabaseid) ON UPDATE CASCADE ON DELETE CASCADE|[externaldatabases](externaldatabases.md) (databaseid)|                         Foreign key reference to external databases or resources.                         |
