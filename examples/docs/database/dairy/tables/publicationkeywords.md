...
|----------------|----------|------------------------------------------------------------------------------------|-----------------------------------------------|--------------------|
|publication_fkey|REFERENCES|FOREIGN KEY (publicationid) REFERENCES publications(publicationid) ON UPDATE CASCADE|[publications](publications.md) (publicationid)|No comment provided.|
|  keyword_fkey  |REFERENCES|      FOREIGN KEY (keywordid) REFERENCES keywords(keywordid) ON UPDATE CASCADE      |      [keywords](keywords.md) (keywordid)      |No comment provided.|
