...
|------------------------------------|-----------|-----------------------------------------------------------------------------------------------------|-----------------------------------------------|----------------------------------------------------------------------------------------|
|  datasetpublications_datasetid_fk  | REFERENCES|      FOREIGN KEY (datasetid) REFERENCES datasets(datasetid) ON UPDATE CASCADE ON DELETE CASCADE     |      [datasets](datasets.md) (datasetid)      |             The foreign key referencing the datasets table in the database.            |
|datasetpublications_publicationid_fk| REFERENCES|FOREIGN KEY (publicationid) REFERENCES publication(publicationid) ON UPDATE CASCADE ON DELETE CASCADE|[publications](publications.md) (publicationid)|           The foreign key referencing the publications table in the database.          |
