...
|keywordsource_fk| REFERENCES|FOREIGN KEY (sourceid) REFERENCES externaldatabases(databaseid)|[externaldatabases](externaldatabases.md) (databaseid)|                   No comment provided.                  |
