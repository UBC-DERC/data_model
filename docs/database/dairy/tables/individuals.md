...
|                                                                                                                        Full name of an individual, in written order (i.e., as they would write their names)                                                                                                                        |      *fullname*      |  text  |
|                                                                                              This is the last name, family name, or singular name that would lead in a journal citation, or when the individual is formally addressed.                                                                                             |     *formalname*     |  text  |
|                                                                                                                         For individuals who have a preferred name that is not the same as their given name.                                                                                                                        |    *preferredname*   |  text  |
...
|                                                                                   In the case a record is replaced with an alternative record (for example an individual changes their name, but the "old" name remains in the publication list).                                                                                  |*superceedingrecordid*|  UUID7 |
