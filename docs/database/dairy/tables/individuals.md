...
|                                                                                                                        Full name of an individual, in written order (i.e., as they would write their names)                                                                                                                       |  text  |      *fullname*      |
|                                                                                             This is the last name, family name, or singular name that would lead in a journal citation, or when the individual is formally addressed.                                                                                             |  text  |     *formalname*     |
|                                                                                                                        For individuals who have a preferred name that is not the same as their given name.                                                                                                                        |  text  |    *preferredname*   |
...
|                                                                                  In the case a record is replaced with an alternative record (for example an individual changes their name, but the "old" name remains in the publication list).                                                                                  |  UUID7 |*superceedingrecordid*|
