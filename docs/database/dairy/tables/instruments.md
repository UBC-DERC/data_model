...
|                                                                        A general description for the particular instrument that can be used to easily  identify the instrument. Should include a technical description of the device and its capabilities.                                                                        |   text   |       *description*       |
|                                                                                                               The proper name by which the instrument is identified. The instrument may have other colloquial names.                                                                                                              |   text   |      *instrumentname*     |
|                                                                                                              Colloquial names used for the instrument. This field should be a text array to support multiple entries.                                                                                                             |text array|*instrumentcolloquialnames*|
|                                                                                                                                                  The manufacturer of the product.                                                                                                                                                 |   UUID7  |      *manufacturerid*     |
|                                                                                                                     The organization through which the equipment was purchased (an alias for institution id).                                                                                                                     |   UUID7  |        *supplierid*       |
...
|                                                                                                         In the case a record is replaced with an alternative record (for example a manufacturer is sold to a new company).                                                                                                        |   UUID7  |   *superceedingrecordid*  |
