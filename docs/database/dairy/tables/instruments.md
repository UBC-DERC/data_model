...
|                                                                        A general description for the particular instrument that can be used to easily  identify the instrument. Should include a technical description of the device and its capabilities.
                                                                        |       *description*       |   text   |
|                                                                                                               The proper name by which the instrument is identified. The instrument may have other colloquial names.                                                                                                               |      *instrumentname*     |   text   |
|                                                                                                              Colloquial names used for the instrument. This field should be a text array to support multiple entries.                                                                                                              |*instrumentcolloquialnames*|text array|
|                                                                                                                                                  The manufacturer of the product.                                                                                                                                                  |      *manufacturerid*     |   None   |
|                                                                                                                                     The organization through which the equipment was purchased.                                                                                                                                    |        *supplierid*       |   None   |
...
|                                                                                                         In the case a record is replaced with an alternative record (for example a manufacturer is sold to a new company).                                                                                                         |   *superceedingrecordid*  |   UUID7  |
